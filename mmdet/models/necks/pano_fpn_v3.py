...
class PanopticFPNV3(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg=None,
                 activation=None):
        super(PanopticFPNV3, self).__init__()
        ...
        """use bn and relu for semantic segmentation and instance coefficience """
        ...
        for i in range(self.start_leve, self.backbone_end_level):
            l_conv = ConvModule(
                in_channels[i],
                out_channels,
                1,
        ...
        # aspp for the 1/8 feature maps,
        # after lateral the ASPP
