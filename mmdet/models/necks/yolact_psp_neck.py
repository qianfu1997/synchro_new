...
class YolactPSPFPN(nn.Module):
    def __init__(self,
                 ...
                 norm_cfg=None,
                 activation=None):
        super(YolactPSPFPN, self).__init__()
        ...
        if end_level == -1:
            ...
            assert num_outs >= self.num_is - start_level
        else:
        ...
        self.proto_logits = nn.Conv2d(out_channels, self.inst_embeds, 1)
