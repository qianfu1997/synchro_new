...
from mmdet.core import auto_fp16, force_fp32, multiclass_nms, delta2bbox
...
class YolactBboxHead(AnchorHead):
    """Anchor-based head.
    Args:
        num_classes,
        inst_embeds,
    ...
    def __init__(self,
        ...
        super(YolactBboxHead, self).__init__(
    ...
    def _init_layers(self):
        ...
        self.yolact_emb = nn.Conv2d(
            self.feat_channels, self.num_anchors * self.inst_embeds, 3, padding=1)
    ...
    def forward_single(self, x):
        ...
        cls_score = self.yolact_cls(cls_feat)
        bbox_pred = self.yolact_reg(reg_feat)
        bbox_embs = self.yolact_emb(emb_feat)
    ...
    def get_proposals(self, cls_scores, bbox_preds, bbox_embeds, img_metas, cfg,
        ...
        for img_id in range(len(img_metas)):
            ...
            proposals = self.get_bboxes_single(cls_scores_list, bbox_pred_list, bbox_embed_list,
    ...
    def get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, bbox_embed, anchors in zip(cls_scores, bbox_preds,
            ...
            assert cls_score.size()[-2:] == bbox_pred.size()[-2:] == bbox_embed.size()[-2:]
            ...
            bbox_embed = bbox_embed.permute(1, 2, 0).contiguous().reshape(-1, self.inst_embeds)
